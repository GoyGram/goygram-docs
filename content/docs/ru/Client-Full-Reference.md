---
title: "Полная справка по клиенту"
---
...
Зарегистрируйте универсальный обработчик для **любого** типа событий (сообщение, cb, опрос, участник). Срабатывает после типизированных обработчиков.

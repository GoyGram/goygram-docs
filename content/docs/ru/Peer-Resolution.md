---
title: "Равноправное разрешение"
---

# Разрешение узла

MTProto требует сериализованных объектов «входного узла» TL для большинства операций чата. GoyGram автоматически преобразует идентификаторы чата Python в ссылки на одноранговые узлы, сериализованные в TL.

...
Идентификаторы сообщений кодируют временную метку (старшие биты) и монотонно увеличивающийся счетчик (младшие биты, увеличиваются на 4). Это стандартный формат MTProto msg_id — Telegram требует монотонно увеличивающегося идентификатора.